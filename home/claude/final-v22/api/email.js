export default async function handler(req, res) {
  ...
  // Generic send (for invoices, custom emails)
  if (action === 'send') {
    ...
    } catch(e) { return res.status(200).json({ sent: false, error: e.message }) }
  }
